...
/* Prime Origins Global — PWA: manifest and home-screen icon.
   No automatic install banner: visitors can still add the site to their home screen from the browser menu. */
(function(){
  ...
  if(!has('link[rel="apple-touch-icon"]')){ var a=document.createElement('link'); a.rel='apple-touch-icon'; a.href='/assets/img/logo.png'; head.appendChild(a); }
